...
const ChoseDelivery = ({ onTabCompletion }) => {
    ...
    <div className='container'>
      ...
      <div className="grid-container">
        <div className="grid-item">
          ...
          <button className="lyout-button" onClick={() => handleConfirmation(0)}>Bekräfta hemleverans</button>
        ...
        <div className="grid-item">
          ...
          <button className="lyout-button" onClick={() => handleConfirmation(1)}>Bekräfta hämta i butik</button>
