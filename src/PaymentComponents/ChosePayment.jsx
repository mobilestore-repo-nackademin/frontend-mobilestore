...
const ChosePayment = ({ onTabCompletion }) => {
        ...
        <div className='container'>
            <div className="grid-container">
                ...
                <div className='grid-item' >
                    ...
                    <svg width="15em" height="15em" viewBox="0 0 1024 1024" className="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000" onClick={() => handleConfirmation(2)}>
                ...
                <h2 className='h2-payment'>Betala med kort</h2>
                    <svg width="15em" height="15em" viewBox="0 0 1024 1024" className="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000" onClick={() => handleConfirmation(3)}>
