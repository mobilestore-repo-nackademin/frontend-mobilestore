...
const DeliveryTerms = () => {
    return (
        <div>
            ...
            <p>Välkommen till vår butiks leveransvillkor. Nedan följer information om hur vi hanterar leveranser:</p>
